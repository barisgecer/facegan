...
train_arg.add_argument('--lr_update_step', type=int, default=128000, choices=[100000, 75000])
train_arg.add_argument('--warm_up', type=int, default=2000)
train_arg.add_argument('--d_lr', type=float, default=0.00008*2)
train_arg.add_argument('--g_lr', type=float, default=0.00008*2)
