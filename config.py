...
net_arg.add_argument('--input_scale_size', type=int, default=128,#64
...
parser.add_argument('--syn_data_dir', type=str,
                    help='Directory where synthetic images generated by 3dmm', default='3dmm/data')
net_arg.add_argument('--syn_scale_size', type=int, default=128,
                     help='input image will be resized with the given value as width and height')
