...
class Trainer(object):
    ...
    def build_model(self):
        ...
        self.g_optim = g_optimizer.minimize(self.g_loss +  0.1* g_reg_loss + 0.000001*self.c_loss+ self.config.lambda_cycle *cycle_loss # + self.config.lambda_ren *render_loss
                                            , global_step=self.step,
